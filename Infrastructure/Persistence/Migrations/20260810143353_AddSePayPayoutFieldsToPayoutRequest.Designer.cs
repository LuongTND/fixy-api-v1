...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810143353_AddSePayPayoutFieldsToPayoutRequest")]
    partial class AddSePayPayoutFieldsToPayoutRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entity.ReferralRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RewardVoucherId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 8, 10, 14, 33, 50, 34, DateTimeKind.Utc).AddTicks(4150),
                            IsActive = true,
                            Name = "ADMIN"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 8, 10, 14, 33, 50, 34, DateTimeKind.Utc).AddTicks(4154),
                            IsActive = true,
                            Name = "CUSTOMER"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 8, 10, 14, 33, 50, 34, DateTimeKind.Utc).AddTicks(4157),
                            IsActive = true,
                            Name = "WORKER"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entity.SpaPartner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SpaPartners");
                });

            modelBuilder.Entity("Domain.Entity.SpaPartnerGallery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SpaPartnerId");

                    b.ToTable("SpaPartnerGalleries");
                });

            modelBuilder.Entity("Domain.Entity.SpaPartnerPromotion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<TimeOnly?>("OffPeakEndTime")
                        .HasColumnType("time");

                    b.Property<TimeOnly?>("OffPeakStartTime")
                        .HasColumnType("time");
                    ...
                    b.ToTable("SpaPartnerPromotions");
                });

            modelBuilder.Entity("Domain.Entity.SpaPartnerReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SpaPartnerReviews");
                });

            modelBuilder.Entity("Domain.Entity.SpaPartnerService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SpaServiceCategoryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SpaServiceCategoryId");

                    b.ToTable("SpaPartnerServices");
                });

            modelBuilder.Entity("Domain.Entity.SpaServiceCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SpaServiceCategories");
                });
            ...
            modelBuilder.Entity("Domain.Entity.UserFcmToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entity.VipMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entity.WorkerServiceOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkerServiceOptions", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entity.ReferralRecord", b =>
                {
                    b.HasOne("Domain.Entity.User", "ReferredUser")
                        .WithMany()
                        .HasForeignKey("ReferredUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entity.User", "ReferrerUser")
                        .WithMany()
                        .HasForeignKey("ReferrerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entity.Voucher", "RewardVoucher")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entity.SpaPartnerGallery", b =>
                {
                    b.HasOne("Domain.Entity.SpaPartner", "SpaPartner")
                        .WithMany("Gallery")
                        .HasForeignKey("SpaPartnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SpaPartner");
                });
            ...
            modelBuilder.Entity("Domain.Entity.SpaPartnerService", b =>
                {
                    ...
                    b.HasOne("Domain.Entity.SpaServiceCategory", "SpaServiceCategory")
                        .WithMany("SpaPartnerServices")
                        .HasForeignKey("SpaServiceCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SpaPartner");

                    b.Navigation("SpaServiceCategory");
                });
            ...
            modelBuilder.Entity("Domain.Entity.WorkerServiceOption", b =>
                {
                    b.HasOne("Domain.Entity.WorkerService", "WorkerService")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Domain.Entity.SpaServiceCategory", b =>
                {
                    b.Navigation("SpaPartnerServices");
                });
