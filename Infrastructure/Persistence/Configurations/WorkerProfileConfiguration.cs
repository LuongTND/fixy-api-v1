...
namespace Infrastructure.Persistence.Configurations
{
    public class WorkerProfileConfiguration : IEntityTypeConfiguration<WorkerProfile>
    {
        public void Configure(EntityTypeBuilder<WorkerProfile> builder)
        {
            ...
            builder.HasIndex(x => new { x.Status, x.RatingAvg }).HasDatabaseName("idx_worker_search");
            builder.HasIndex(x => new { x.Status, x.IsOnline }).HasDatabaseName("idx_worker_available");
