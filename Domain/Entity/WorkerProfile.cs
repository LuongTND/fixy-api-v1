...
namespace Domain.Entity
{
    public class WorkerProfile : BaseEntity, ISoftDelete
    {
        ...
        public ICollection<WorkerServiceArea> ServiceAreas { get; set; } = new List<WorkerServiceArea>();
        ...
        public ICollection<WorkerPayoutAccount> PayoutAccounts { get; set; } = new List<WorkerPayoutAccount>();
        public ICollection<WorkerFeaturedOrder> FeaturedOrders { get; set; } = new List<WorkerFeaturedOrder>();
